      ...
      <div className="flex flex-col items-center justify-center py-[70px] px-[30px]">
        ...
        <div className="flex my-[10px] max-w-[1200px]">
          <p className="font-outfit text-[17px] mr-[40px] flex items-center">
            ...
            asal disney 😭😭. Dan akhirnya kita nemu lagu bagus untuk diduetkan
            dan rekam dehhh (gatau berapa lama kita ulang ulang terus yaa
            😭😭😭😭) Suara ketawa aku kaya ayam berkokok ya ❤️❤️❤️❤️
          </p>
          <video
        ...
        <div className="flex my-[10px] max-w-[1200px]">
          ...
          />
          <p className="font-outfit text-[17px] ml-[40px] flex items-center">
            Wahh ini kita pas double date kedua bersama putri dan kevin !! Kita
            bermain ice skatinggg dan kita juga pertama kali bermain ini kan 😭.
            Tapi kamu NATURAL GITU JAGONYA, dan kebalik kamu yang megangin aku
            😭😭. Tapi aku paling ingat ada satu momen kamu yang salting pas
            kamu jatuh aku ikutan jatuh hehehehehe ❤️❤️❤️❤️
          </p>
        </div>
        ...
        <div className="flex my-[10px] max-w-[1200px]">
          <p className="font-outfit text-[17px] mr-[40px] flex items-center">
            ...
            senang hehehe (Ini juga pertama kali chei ke lembang pake motor dan
            sangat excited hehehe) ❤️❤️❤️❤️ LIAT LUCU BANGET DIAAAA HIKSSS MY
            PACARRR
          </p>
          <video
        ...
        <div className="flex my-[10px] max-w-[1200px]">
          ...
          />
          <p className="font-outfit text-[17px] ml-[40px] flex items-center">
            Kalo yang ini, disaat kita lagi main ke paskal, ehh ada wahana baruu
            gituu, bukan wahana sih tapi tempat rekreasi gituu, meski tempatnya
            kecil tapi kami sangatlah senang berfoto foto disana, dan juga ada
            wahana slide ituu yang seruu !! ❤️❤️❤️❤️
          </p>
        </div>
