  ...
  return (
    <div className="bg-fuchsia-100 ">
      ...
      <div className="flex flex-col items-center justify-center py-[70px] px-[30px]">
        ...
        <div className="flex my-[10px] max-w-[1200px]">
          <p className="font-outfit text-[17px] mx-[10px] flex items-center">
            Inii editan kiyowo juga niichhhh ! Aku buat saat beberapa bulan kita
            ketemu for the first time, karena kamu super kiyowo hehehehe (GILAA
            UDAH I LOVE YOU I LOVE YOU ANNN 😭😭😭😭) ❤️❤️❤️❤️
          </p>
          <video
        ...
        <div className="flex my-[10px] max-w-[1200px]">
          ...
          />
          <p className="font-outfit text-[17px] mx-[10px] flex items-center">
            Nahhh kalau yang ini editan paling keren paling kiyowo bahkan editan
            ini satu satunya yang aku post di short yt dan banyak yang nonton
            😭😭😭😭😭😭
          </p>
        </div>
